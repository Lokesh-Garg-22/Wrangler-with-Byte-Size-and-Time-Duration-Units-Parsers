...
## New Features Added for Work

- **ByteSize Parser**, allows you to parse byteSize inputs into its various units (like B, Kb, MB, GB and TB). Useage: `parse-as-byte-size :columnName "byteUnit"`, byteUnit is optional and of type "B", "KB", "MB", "GB" or "TB".

- **TimeDuration Praser**, allows you to parse timeDuration inputs into its various units (like ms, s, m, h and d). Useage: `parse-as-time :columnName "timeUnit"`, timeUnit is optional and of type "ms", "s", "m", "h", "d".

- **ByteSize and TimeDuration Aggregation**, allows you to aggregate the byteSize and timeDuration inputs. Useage: `aggregate-byte-time :byteColumnName :timeColumnName "aggregateType" "byteUnit" "timeUnit"`, aggregateType is optional and of type "total" or "avarage", byteUnit is optional and of type "B", "KB", "MB", "GB" or "TB", timeUnit is optional and of type "ms", "s", "m", "h", "d".
